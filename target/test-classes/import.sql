...
insert into INTERVENANT_SESSIONS(formateurs_id, sessions_id)VALUES ( 6,1 );
...
insert into INTERVENANT_SESSIONS(formateurs_id, sessions_id)VALUES ( 5,2 );
insert into INTERVENANT_SESSIONS(formateurs_id, sessions_id)VALUES ( 6,3 );
...
-- insert into SESSION_FORMATEURS(sessions_id, formateurs_id) VALUES ( 1,5 );
-- insert into SESSION_FORMATEURS(sessions_id, formateurs_id) VALUES ( 1,6 );
--
-- insert into SESSION_FORMATEURS(sessions_id, formateurs_id) VALUES ( 2,4 );
-- insert into SESSION_FORMATEURS(sessions_id, formateurs_id) VALUES ( 2,5 );
-- insert into SESSION_FORMATEURS(sessions_id, formateurs_id) VALUES ( 2,5 );
--
-- insert into SESSION_FORMATEURS(sessions_id, formateurs_id) VALUES ( 3,6 );
-- insert into SESSION_FORMATEURS(sessions_id, formateurs_id) VALUES ( 3,4 );
--
-- insert into SESSION_FORMATEURS(sessions_id, formateurs_id) VALUES ( 4,4 );
-- insert into SESSION_FORMATEURS(sessions_id, formateurs_id) VALUES ( 4,1 );
--
-- insert into SESSION_FORMATEURS(sessions_id, formateurs_id) VALUES ( 5,5 );
-- insert into SESSION_FORMATEURS(sessions_id, formateurs_id) VALUES ( 5,4 );


insert into REAC(nom,date_debut, durer, lien, formation_id) values ('CDA reac', '2019-01-01',5,'lien',1 );
insert into REAC(nom,date_debut, durer, lien, formation_id) values ('DWWM reac', '2019-01-01',5,'lien',2 );
...
-- insert into EVALUATION(MODALITE)values ( 'modalite eval DW 1' );
-- insert into EVALUATION(MODALITE)values ( 'modalite eval DW 2' );
-- insert into EVALUATION(MODALITE)values ( 'modalite eval autre 1' );
-- insert into EVALUATION(MODALITE)values ( 'modalite eval CDA 1' );
-- insert into EVALUATION(MODALITE)values ( 'modalite eval CDA 2' );
-- insert into EVALUATION(MODALITE)values ( 'modalite eval autre 2' );
...
insert into SEANCE(id,date_du_jour, deroulement, durer, methode_envisagee, objectif_peda, support_use, evaluation, formateur_id, session_id) VALUES (18, '2020-03-08','',4, '','','','',6,5 );
